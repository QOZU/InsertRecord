...
#[derive(Debug)]
pub struct InsertRecordProcessor {
    verbose: bool,
    processed_count: usize,
}

impl InsertRecordProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting InsertRecord processing");
    
    let mut processor = InsertRecordProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = InsertRecordProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = InsertRecordProcessor::new(false);
